    ...
    <div className={styles.user}>
      ...
      <div className={cn(styles.userAccount, styles.userAccountDelivery)}>
        ...
        <div>
          ...
          <Text view="p-20">The nearest delivery: not expected</Text>
        </div>
      </div>
      ...
      <div className={cn(styles.userAccount, styles.userAccountDiscount)}>
        ...
        <div>
          ...
          <Text view="p-20">Get a discount on your first order</Text>
        </div>
      </div>
      <div className={cn(styles.userAccount, styles.userAccountNews)}>
        ...
        <div>
          ...
          <Text view="p-20">Do not miss the new collection of clothes in a week</Text>
        </div>
      </div>
    </div>
  );
